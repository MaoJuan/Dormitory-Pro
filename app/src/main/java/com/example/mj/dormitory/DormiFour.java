...
public class DormiFour extends Activity implements View.OnClickListener{
    EditText username1, vcode1,username2,vcode2,username3,vcode3, buildnum;
    Button button;
            ...
            switch (msg.what) {
                case UPDATE_TODAY_WEATHER:
                    ...
                    if(www.equals("{\"errcode\":0}")) {
                        Intent i=new Intent(DormiFour.this,SearMes.class);
                        i.putExtra("number",xuehao);
                        startActivity(i);
                    }
                    else {
                        new AlertDialog.Builder(DormiFour.this).setTitle("提示").setMessage("填写错误").setPositiveButton("返回", null).show();
                    }
                    break;
                default:
                    break;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dorfour);
        ...
        if (CheckNet.getNetState(this) == CheckNet.NET_NONE) {
            Log.d("MDOR", "网络不通");
            Toast.makeText(DormiFour.this, "网络不通", Toast.LENGTH_LONG).show();
        } else {
            Log.d("MDOR", "网络OK");
            Toast.makeText(DormiFour.this, "网络OK", Toast.LENGTH_LONG).show();
        }
        initview();
    }
    ...
    public void initview() {
        ...
        username3 = (EditText) findViewById(R.id.username3ET);
        vcode3 = (EditText) findViewById(R.id.password3ET);
    ...
    public StringBuffer getRequestData(){
        ...
        try{
            ...
            stringBuffer.append("stu3id").append("=").append(username3.getText().toString()).append("&");
            stringBuffer.append("v3cod").append("=").append(vcode3.getText().toString()).append("&");
